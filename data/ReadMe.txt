...
El Haouij N., Poggi J.-M, Sevestre-Ghalila S., Ghozi R., and Jaïdane M. 2018. AffectiveROAD system and database to assess driver's attention. In Proceedings of the 33rd Annual ACM Symposium on Applied Computing (SAC '18). ACM, New York, NY, USA, 800-803. DOI: https://doi.org/10.1145/3167132.3167395
...
and 1 file: Records.txt lists the 13 driveID. A note is written when the driver performed more than one drive. For the ID containing the number 1, this designate that the driver perfomed only one drive.
